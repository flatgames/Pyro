#include "BatchedNinePatchSprite.h"
...
namespace Pyro
{
	...
	namespace Components
	{
		...
		namespace Helpers
		{
			...
			BatchedNinePatchSprite * BatchedNinePatchSprite::createWithFile(const std::string &filename, const cocos2d::Rect &insets)
			{
				...
				return BatchedNinePatchSprite::createWithSpriteFrame(spriteFrame, insets);
			}

			BatchedNinePatchSprite * BatchedNinePatchSprite::createWithSpriteFrame(cocos2d::SpriteFrame *spriteFrame, const cocos2d::Rect &insets)
			{
				auto sprite = new BatchedNinePatchSprite();
			...
			BatchedNinePatchSprite * BatchedNinePatchSprite::createWithSpriteFrameName(const std::string &spriteFrameName, const cocos2d::Rect &insets)
			{
				auto spriteFrame = SpriteFrameCache::getInstance()->getSpriteFrameByName(spriteFrameName);
				return BatchedNinePatchSprite::createWithSpriteFrame(spriteFrame, insets);
			}

			BatchedNinePatchSprite::BatchedNinePatchSprite(void)
			...
			void BatchedNinePatchSprite::setContentSize(const cocos2d::Size &size)
			{
			...
			bool BatchedNinePatchSprite::initWithSpriteFrame(cocos2d::SpriteFrame *spriteFrame, const cocos2d::Rect &insets)
			{
				...
				if (!SpriteBatchNode::initWithTexture(texture, 9))
					return false;
